    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body px-5 pt-2 pb-2">
                ...
                <?php echo inputWithFormGroup('No Surat Perintah Penyidikan', 'text', 'no_surat_tugas', 'No Surat Perintah Penyidikan',[],['id'=> 'no_surat_tugas']) ?>
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="d-flex justify-content-end">
                    <?php echo button('Save', ["btn-primary"], ["id" => "btnSave", "onclick" => "savePenyidikan()"]); ?>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
...
<script>
    ...
    $('body').delegate("#pengaduan", "change", (e) => {
        ...
        if (id == 0) {
            ...
            $.ajax({
                url: base_url + 'kejati/ajax/penyidikan/pengaduan',
                type: "POST",
                data: {
                    id: id
                },
    ...
    $('body').delegate("#sop", "change", (e) => {
        ...
        if (id == 0) {
            ...
            $.ajax({
                url: base_url + 'kejati/ajax/penyidikan/sop',
                type: "POST",
                data: {
                    id: id
                },
