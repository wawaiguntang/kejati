                                ...
                                <div class="card card-body py-1 mb-1 mx-1 px-2" style="border: 1px solid #D4D4D4;" id="kegiatan">
                                    <div class="row">
                                        <div class="col-md-6">
                                                                    ...
                                                                    ?>
                                                                        <li>
                                                                            ...
                                                                            <?php if ($m['dokumen'] != NULL) { ?>
                                                                                <a href="<?php echo base_url('kejati/penyidikan/download/' . encrypt('\assets\kejati\files\\' . $m['dokumen']) . '/' . $m['dokumen']) ?>" style="text-decoration: none;"><i class="ri-file-download-line ri-lg text-primary" role="button" title="Download Kelengkapan"></i></a>
                                                                            <?php } ?>
                                                                        </li>
                                                                    <?php
                                                                    }
                                                                    ...
                                                                    ?>
                                                                        <li>
                                                                            ...
                                                                            <?php if ($z['dokumen'] != NULL) { ?>
                                                                                <a href="<?php echo base_url('kejati/penyidikan/download/' . encrypt('\assets\kejati\files\\' . $z['dokumen']) . '/' . $z['dokumen']) ?>" style="text-decoration: none;"><i class="ri-file-download-line ri-lg text-primary" role="button" title="Download Kelengkapan"></i></a>
                                                                            <?php } ?>
                                                                        </li>
                                                                    <?php
                                                                    }
                                            ...
                                            <?php
                                            if (($v['status'] == 'Ditinjau atasan') && (in_array('ACCPENYIDIKAN', $userPermission))) {
                                            ?>
...
<script>
    ...
    function terimaTolak(detail_tugas_id = '', tipe = 'terima') {
        ...
        $.ajax({
            url: base_url + 'kejati/ajax/penyidikan/terimaTolak',
            type: "POST",
            data: {
    ...
    function saveCatatan() {
        ...
        url = base_url + 'kejati/ajax/penyidikan/saveCatatan';
        method = "saved";
