<div class="row">
    <div class="col-md-8 offset-md-2">
        ...
        <?php echo inputWithFormGroup('Kelengkapan', 'text', 'kelengkapan', 'Kelengkapan', [], ["value" => $kelengkapan]); ?>
...
<script>
    ...
    function save() {
        ...
        if (save_label == "add") {
            url = base_url + 'kejati/ajax/sop/addKelengkapan';
            method = "saved";
        } else {
            url = base_url + 'kejati/ajax/sop/updateKelengkapan';
            method = "updated";
        }
