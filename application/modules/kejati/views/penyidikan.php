...
<script>
    ...
    function getData() {
        $.ajax({
            url: base_url + 'kejati/ajax/penyidikan/data',
            type: "GET",

            success: function(data) {
                $(".data").html(data.data);
                breadcrumb(data.breadcrumb);
                let list = $("#penyidikan").DataTable({
                    processing: true,
                    serverSide: true,
                    order: [],
                    ajax: {
                        url: base_url + 'kejati/ajax/penyidikan/list',
                        type: "POST",
                    },
                    columnDefs: [{
                        targets: [-1],
    ...
    function addData() {
        save_label = "add";
        $.ajax({
            url: base_url + 'kejati/ajax/penyidikan/addHTML',
            type: "POST",
    ...
    function savePenyidikan() {
        ...
        url = base_url + 'kejati/ajax/penyidikan/save';
        method = "saved";
    ...
    function detail(tugas_id = '') {
        $.ajax({
            url: base_url + 'kejati/ajax/penyidikan/detail',
            type: "POST",
            data: {
                tugas_id: tugas_id,
            },
