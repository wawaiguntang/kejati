...
class Users_model extends CI_Model
{
	...
	var $table = 'user';
	var $column_order = array('name','email'); //set column field database for datatable orderable
	var $column_search = array('name','email'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	...
	{
		$this->db->from($this->table);
		$this->db->where('userCode', $id)->where('deleteAt',NULL);
		$query = $this->db->get();
